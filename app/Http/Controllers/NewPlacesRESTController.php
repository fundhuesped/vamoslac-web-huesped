...
class NewPlacesRESTController extends Controller{
  ...
  public function store(Request $request)
  {
    ...
    $rules = array(
      ...
      'idPartido'       => 'required_without_all:newCityAdded',
      'idPais'          => 'required_without_all:newCityAdded',
      'idProvincia'     => 'required_without_all:newCityAdded',
      'idCiudad'        => 'required_without_all:newCityAdded',
      'calle'           => 'required',
      'tipo'            => 'required',
    );
