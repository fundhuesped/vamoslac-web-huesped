	...
	<table class="striped responsive-table">
		...
		<tbody>
			...
			<tr>
				...
				<td class="services2">
					<img ng-show="{{ $p['condones'] && !$p['friendly_condones'] }}" title="Este lugar distribuye preservativos" src="../../images/condones.svg">
					<img ng-show="{{ $p['friendly_condones'] }}" title="Este lugar distribuye preservativos" src="../../images/condones_friendly.svg">

					<img ng-show="{{ $p['prueba'] && !$p['friendly_prueba'] }}" title="Este lugar puede hacer prueba de HIV" src="../../images/vih.svg">
					<img ng-show="{{ $p['friendly_prueba'] }}" title="Este lugar puede hacer prueba de HIV" src="../../images/vih_friendly.svg">

					<img ng-show="{{ $p['mac'] && !$p['friendly_mac'] }}" title="Este lugar cuenta con métodos anticonceptivos" src="../../images/mac.svg">
					<img ng-show="{{ $p['friendly_mac'] }}" title="Este lugar cuenta con métodos anticonceptivos" src="../../images/mac_friendly.svg">

					<img ng-show="{{ $p['ile'] && !$p['friendly_ile'] }}" title="Este lugar cuenta con interrupción legal del embarazo" src="../../images/ile.svg">
					<img ng-show="{{ $p['friendly_ile'] }}" title="Este lugar cuenta con interrupción legal del embarazo" src="../../images/ile_friendly.svg">

					<img ng-show="{{ $p['dc'] && !$p['friendly_dc'] }}" title="Este lugar cuenta con detección dle cáncer" src="../../images/deteccion.svg">
					<img ng-show="{{ $p['friendly_dc'] }}" title="Este lugar cuenta con detección dle cáncer" src="../../images/deteccion_friendly.svg">

					<img ng-show="{{ $p['ssr'] && !$p['friendly_ssr'] }}" title="Este lugar cuenta con servicios de salud sexual y reproductiva" src="../../images/salud.svg">
