<div id="activos" class="col s12">
  ...
  <div class="row">
    <div class="col s6">
      <a href="" ng-click="getNow()" class="waves-effect waves-light btn wow">
        ...
        </i><span translate="search_by_location"></span>
      </a>
    </div>
    <div class="col s6">
      <a  href="" ng-click="activePlacesExport()" class="waves-effect waves-light btn wow">
        ...
        </i><span translate="panel_actives_export_data"></span>
      </a>
    </div>
  </div>
  <hr/>
  ...
  <div class="row">
    <div class="col s6">
      <a ng-click="searchNow()" class="waves-effect waves-light btn wow mb-1">
        <i class="mdi-navigation-chevron-right right"></i>
        <i class="mdi-editor-format-list-bulleted left"></i>
        <span translate="panel_actives_search_by_name_street"></span>
      </a>
    </div>
    <div class="col s6">
      <a href="/panel/importer/front-export/[[searchQuery]]" class="waves-effect waves-light btn wow">
        <i class="mdi-navigation-chevron-right right"></i>
        <i class="mdi-file-file-download left">
        </i><span translate="panel_actives_export_data"></span>
      </a>
  ...
  <div class="stats" ng-cloak ng-hide="loadingPrev">
    <div class="row" ng-hide="!places">
      ...
      <h3 ng-if="optionMaster2" class="title" translate="panel_actives_summary_2" translate-values="{places: '[[places.length]]'}">
      </h3>
      <div class="nav-wrapper"  ng-cloak ng-hide="loadingPrev"></div>
    </div>
  ...
  <div ng-controller="tableController" ng-init="init('places','establecimiento')" class="col s12 mb-3" ng-cloak ng-hide="!places">
    <nav>
      <div class="ng-cloak nav-wrapper col s12" ng-cloak ng-hide="loadingPrev && places.length === 0">
        <div class="row">
...
{{--         <div class="row mt-1">
    ...
    <h3 ng-cloak ng-show="places.length == 0 && !loadingPrev">
      <span translate="panel_actives_no_results_1"></span> <span  ng-cloak ng-show="searchExistence">'[[searchExistence]]'</span> <span ng-cloak ng-show="filterLocalidad" translate="panel_actives_no_results_2" translate-values="{location:'[[filterLocalidad]]'}"></span>
    </h3>
